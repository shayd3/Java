...
public class MultiStringColl {
     ...
     *
     * @param s positive integer to insert in object
     */
    ...
    /**
     * Take in string s, if s exists in the collection, delete it. decrement howmany
     *
...
//                System.out.println("p: " + p);
    ...
    private static class btNode
    {
         ...
         public btNode()
         {
             info=null; left=right=null; count = 0;
         }

         public btNode(String i, btNode lt, btNode rt, int c)
         {
             info=i; left=lt; right=rt; count = c;
         }
   }
}
